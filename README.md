...
| **Embedded Linux** <br>**& BSP** | **내가 한 일:** Yocto 이미지/레이어(meta-*) 구성 + DT 오버레이 + systemd/udev 자동기동으로 “부팅 후 즉시 동작” 구조 구축<br><br>• Yocto : RPi5용 이미지 빌드, meta-layer 작성 <br>• Device Tree : 오버레이 적용 및 커널 설정 <br>• System : systemd 서비스 등록, MCP2515(CAN) 설정<br><br>**Evidence:** 레포 내 `meta-*` 폴더/서비스 파일 링크 | [AI-Black-Box](https://github.com/nasi546/AI-Black-Box)<br>[E.S.S.E.N.T.I.A.L](https://github.com/nasi546/ess-guardian) |
